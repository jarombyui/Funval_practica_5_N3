...
export const Main = () => {
  return (
    <section>
      ...
      <p className='absolute font-Fraunces text-[40px] uppercase trcking-[6.25px]  text-white text-center w-[327px] top-[144px] left-0 right-0 mx-auto sm:w-[600px]'>We are creatives</p>
